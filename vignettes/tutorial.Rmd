...
inla_fit <- phybrr(phy = tree, data = x, obs_error = "one", verbose = FALSE)
summary(inla_fit)
...
```{r lambfa_fix}
inla_fit2 <- phybrr(phy = tree, data = x, obs_error = "one", hyper = RR_fit$lambda,
                   verbose = FALSE)
summary(inla_fit2)
...
inla_fit2 <- phybrr(phy = tree, data = x, obs_error = "est", hyper = RR_fit$lambda,
                   verbose = FALSE)
summary(inla_fit2)
...
```{r full_fit}
inla_fit3 <- phybrr(phy = tree, data = x, obs_error = "est",
                   verbose = FALSE)
summary(inla_fit3)
...
inla_fit_o <- phybrr(phy = tree, data = x, obs_error = "est", verbose = FALSE)
summary(inla_fit_o)
