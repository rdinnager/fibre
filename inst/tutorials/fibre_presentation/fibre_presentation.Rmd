...
- Use a multivariate 'shrinkage' prior on rate with independent variation in all dimensions and a single shrinkage parameter.
...
Essentially this is dimension reduction, but where the latent space is constrained to be consistent with a model of evolutionary change on a phylogeny.
